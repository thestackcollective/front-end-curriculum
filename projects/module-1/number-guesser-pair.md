...
- Follow the directions [here](https://frontend.thestackcollective.org/lessons/module-1/github-repo.html) to set up a local Git repository and connect it to a remote GitHub repository.
