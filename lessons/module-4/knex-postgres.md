...
Let's write some express code to interact with our newly seeded database. [Set up a simple express server](https://frontend.thestackcollective.org/lessons/module-4/intro-to-express.html) and we'll add some configuration to work with the knex database:
