...
```SQL
INSERT INTO users ( name, email ) VALUES ( 'Nate Allen', 'nate@thestackcollective.org' );
```
...
- Some Backend Mod 2 lessons:
  - http://backend.thestackcollective.org/module2/lessons/visualising_and_implementing_database_relationships
...
`db.users.insert({name: "Nate Allen", email: "nate@thestackcollective.org"})`
