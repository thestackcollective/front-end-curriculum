...
[Walker Texas Rangerbox](http://frontend.thestackcollective.org/projects/walker-texas-rangerbox.html)  
[Self-Directed Project](http://frontend.thestackcollective.org/projects/self-directed-project.html)  

### Group Work

[Weather Forecast](http://frontend.thestackcollective.org/projects/weather-forecast.html) or [Movie Tracker](#)  
[remEMBER](http://frontend.thestackcollective.org/projects/remember.html)  
[Ultimate UX Design Challenge](http://frontend.thestackcollective.org/projects/ultimate-ux-ui-team-challenge.html)  
...
* Following up on the *Portfolio Tips & Tricks* tutorial, notify [Meg via email](mailto:mstewart@thestackcollective.org) that your portfolio is complete with your name, photo, description, three projects, and resume.
* Following the *Finding Opportunities* session, add [Meg](mailto:mstewart@thestackcollective.org) as a collaborator to your Trello board with 10 companies. No other submission is necessary.
* Following up on the *Job Search Action Plan* & *Flower Exercise Follow-Up*, submit to [Meg via email](mailto:mstewart@thestackcollective.org) a plan following the supplied template in a gist by the submission time above and include the gist in your portfolio.
