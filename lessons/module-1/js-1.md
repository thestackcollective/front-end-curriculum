...
<section class="call-to-action">
  ...
  <ul>
    ...
    <li>Write a function that declares a `firstName` variable and a `lastName` variable, then logs a message that incorporates the full name, and then logs a <a href="http://frontend.thestackcollective.org/independent-study/random-numbers.html">random number</a> to the console.</li>
  </ul>
</section>
