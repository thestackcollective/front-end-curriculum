...
We've [already learned](https://frontend.thestackcollective.org/lessons/module-1/js-3-dom-manipulation.html) that the DOM (the Document Object Model) is a representation of the HTML file, and that it is an interface that allows us to interact with the HTML file and browser using JavaScript.
