...
## Learning Goals
- [Be able to use git and GitHub to collaborate on code with another developer](https://frontend.thestackcollective.org/lessons/module-1/dev-skills-git-team-workflow.html)
...
- You can also reference [this lesson](https://frontend.thestackcollective.org/lessons/module-1/git-merge-conflicts.html)
</section>
