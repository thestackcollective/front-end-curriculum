...
Let's take a look at the [personal site project spec](http://frontend.thestackcollective.org/projects/personal-site-first-draft.html). Here we see the basic content you'll need to work with in your personal site. Nothing too surprising here, but it's good to understand what you need to be working with before you start sketching. Here's what we need to include:
