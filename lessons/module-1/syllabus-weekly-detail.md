...
|Lessons     |[JS III](http://frontend.thestackcollective.org/lessons/module-1/js-3-dom-manipulation.html) &nbsp; [Flexbox](http://frontend.thestackcollective.org/lessons/module-1/introduction-to-flexbox.html) &nbsp; [Intro Git & Github](http://frontend.thestackcollective.org/lessons/module-1/git-and-github.html) &nbsp; [Unit Testing](http://frontend.thestackcollective.org/lessons/module-1/introduction-to-testing-javascript.html) &nbsp; [JS Foundations Exercises](https://github.com/turingschool-examples/javascript-foundations) &nbsp; [Design I](http://frontend.thestackcollective.org/lessons/module-1/design-1.html) |
|Assignment  | __Eval__: Sun 6/30 ~ Dog Party 2.0 by *5:00 PM* |

### WK 3: Level Up

|Mindset     | _Dig Deep, show grit, be vocal, be resourceful_. |
|Lessons     | [JS IV](http://frontend.thestackcollective.org/lessons/module-1/js-4.html) &nbsp; [Intro Responsive](http://frontend.thestackcollective.org/lessons/module-1/intro-responsive.html) &nbsp; [Event Bubbling & Delegation](http://frontend.thestackcollective.org/lessons/module-1/event-bubbling-and-delegation.html) &nbsp; [Grid](http://frontend.thestackcollective.org/lessons/module-1/introduction-to-grid.html) |
