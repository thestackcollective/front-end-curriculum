...
* Start with the [Reset vs Normalize](https://frontend.thestackcollective.org/lessons/module-1/reset-vs-normalize) lesson
...
* Start with the [CSS Transitions, Transformations, Animations](https://frontend.thestackcollective.org/lessons/module-1/css-transitions-transformations) lesson
