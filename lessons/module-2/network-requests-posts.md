...
Reflecting on the [How the Web Works](https://frontend.thestackcollective.org/lessons/module-2/how-the-web-works.html){:target='blank'}, what makes up the request?  What additional information might we need to send in our `fetch` request?
</section>
