...
Let's go back to our previous example with an Instructor used in the [last lesson](https://frontend.thestackcollective.org/lessons/module-2/oop-2-objects-and-prototype-chain.html):
